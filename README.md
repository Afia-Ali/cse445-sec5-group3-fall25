# cse445-sec5-group3-fall25
Goal - The primary goal of this project is to develop a machine learning–based autonomous driving system that enables a vehicle to navigate without human intervention. The system is designed using a modular approach, where different components work together to understand the driving environment and make navigation decisions.
Lane detection - Implementation of road lane detection using a lightweight YOLOv8n model for real-time performance.
